...
columns = [qtable.CheckBoxColumnDfn(),
           qtable.ColumnDfn(u'出库单号', 'orderNo', percent=10, type=qtable.TextType(), readonly=True),
           qtable.ColumnDfn(u'客户', 'customerName', percent=10, type=qtable.TextType(), readonly=True),
           qtable.ColumnDfn(u'仓库', 'shName', percent=10, type=qtable.TextType(), readonly=True),
           qtable.ColumnDfn(u'出库类型', 'orderTypeName', percent=20, type=qtable.TextType(), readonly=True),
           qtable.ColumnDfn(u'出库状态', 'orderStatusName', percent=20, type=qtable.TextType(), readonly=True),
           qtable.ColumnDfn(u'描述', 'orderDesc', percent=20, type=qtable.TextType(), readonly=True),
           qtable.ColumnDfn(u'备注', 'remark', percent=20, type=qtable.TextType(), readonly=True),
           qtable.ColumnDfn(u'出库时间', 'ctime', size=150, type=qtable.TextType(), readonly=True)
           ]
YES_NO = 1
SAVE_NO = 2
ORDER_TYPE_VALUE = "出库类型"
ORDER_STATUS_VALUE = "出库状态"


########################################################################
class OutStoreHousePanel(wx.Panel):
    ...
    def drawTopPanel(self):
        ...
        orderNo = wx.StaticText(self.top, label=u'出库单号：')
        hbox1.Add(orderNo, flag=wx.RIGHT, border=8)
        self.tc_orderNo = wx.TextCtrl(self.top, size=wx.Size(100, -1))
        hbox1.Add(self.tc_orderNo, flag=wx.RIGHT, border=8)
        orderType = wx.StaticText(self.top, label=u'出库类型：')
        hbox1.Add(orderType, flag=wx.RIGHT, border=8)
        self.choice_orderType = wx.Choice(self.top, size=wx.Size(60,-1))
        hbox1.Add(self.choice_orderType, flag=wx.RIGHT, border=8)
        customerName = wx.StaticText(self.top, label=u'客户：')
        ...
        outdate = wx.StaticText(self.top, label=u'出库日期：')
        ...
        self.add_button.SetToolTipString(u"添加出货单")
        ...
        self.del_button.SetToolTipString(u"撤回出货单")
